...
import { capitalizeFirstLetter, getNiceNumber } from '@/helpers/misc';
...
export default function MapHeader({
  ...
  return (
    <div className={`${manrope.className} selectors`}>
      ...
      <div className="selection-total">
        ...
        <p>
          ~
          {getNiceNumber(
            dataSummary.max_min_sums[summaryType][fertType].sums_by_year[year]
          ).toLocaleString()}{' '}
          kgs
        </p>
      </div>
